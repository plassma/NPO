...
def pad_graph(graph_with_meta, dataset_statistics):
    """Pad a single graph using stored dataset statistics."""
    ...
    return type(graph_with_meta)(graph, graph_with_meta.meta)
