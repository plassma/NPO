...
class Base(ABC):
    def __init__(self, config, EnergyClass, NoiseClass, model):
        ...
        def _make_one_step_force_samples(params, graphs, X_prev, X_next, energy_per_node, t_idx_per_node, key, step=0):
            return self.model.make_one_step_force_samples(
                params, graphs, X_prev, X_next, energy_per_node, t_idx_per_node, key, step=step
            )
        ...
        self._vmapped_make_one_step_force_samples = jax.vmap(
            ...
            in_axes=(None, None, 1, 1, 1, None, 0, None),
            out_axes=(1, 0),
        )
